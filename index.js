let participantes = [
  ...
  },
  {
    ...
    dataCheckIn: new Date(2024, 2, 28, 16, 20)
  },
  {
    nome: "Carlos Santos",
    email: "carlos.santos@gmail.com",
    dataInscricao: new Date(2024, 2, 26, 16, 10),
    dataCheckIn: new Date(2024, 2, 29, 20, 45)
  },
  {
    nome: "Juliana Lima",
  ...
  },
  {
    ...
    dataInscricao: new Date(2024, 2, 29, 20, 45),
    dataCheckIn: null
  },
  {
    nome: "Fernanda Pereira",
    email: "fernanda.pereira@gmail.com",
    dataInscricao: new Date(2024, 2, 30, 18, 0),
    dataCheckIn: new Date(2024, 3, 4, 11, 20)
  },
  {
    nome: "Gustavo Santos",
    email: "gustavo.santos@gmail.com",
    dataInscricao: new Date(2024, 2, 31, 12, 30),
